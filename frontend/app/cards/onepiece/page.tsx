...
export const metadata: Metadata = {
  ...
  description:
    "ワンピースカードゲーム全カードの最新相場 (販売価格・買取価格)。複数の取扱いサイトから集計した中央値を表示。セット別・カード名検索対応。",
  alternates: { canonical: "/cards/onepiece" },
  openGraph: {
    title: "ワンピカード価格DB - TCG Authority",
    description: "ワンピースカード全カードの最新相場 (中央値) をセット別・カード名検索で確認。",
    url: "/cards/onepiece",
  },
};
...
export default async function OnePieceCardsPage({
  searchParams,
}: {
  ...
  // 重い search + 価格集計は Suspense 配下で stream。
